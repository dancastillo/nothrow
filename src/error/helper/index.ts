 ...
 */
export const ERROR_TYPE_TO_DEFAULT_ERROR_MESSAGE_MAP: Record<ERROR_TYPE, string> = {
 ...
 */
export const transformERROR_TYPEToDefaultErrorMessage = (input: ERROR_TYPE): string => {
